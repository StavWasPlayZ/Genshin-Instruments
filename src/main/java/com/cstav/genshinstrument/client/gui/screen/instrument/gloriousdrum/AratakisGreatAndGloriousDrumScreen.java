...
public class AratakisGreatAndGloriousDrumScreen extends InstrumentScreen {
    ...
    protected void init() {
        ...
        final LinearLayoutWidget layout1 = createRow(GloriousDrumButtonType.DON, 2f),
    ...
    private LinearLayoutWidget createRow(GloriousDrumButtonType type, float widthPercent) {
    ...
    private GloriousDrumNoteButton createButton(GloriousDrumButtonType btnType, LinearLayoutWidget container, boolean isRight) {
